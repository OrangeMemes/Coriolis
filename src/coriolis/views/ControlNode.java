    ...
    public ControlNode(String label, double sliderLeftBound, double sliderRightBound, double defaultValue) {
        ...
        field.textProperty().bindBidirectional(value, new NumberStringConverter(Locale.ENGLISH) {
            ...
            public Number fromString(String value) {
                ...
                return Math.max(parsed.doubleValue(), sliderLeftBound);
            }
        ...
        getColumnConstraints().get(0).setPrefWidth(170);
        getColumnConstraints().get(1).setHgrow(Priority.ALWAYS);
        getColumnConstraints().get(2).setPrefWidth(55);
    }
